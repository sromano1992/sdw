...
public class Message {
	...
	public String toString(){
		...
		toReturn = toReturn.replace("sec.app.clockpackage", "clock");
		toReturn = toReturn + destInfo;
		toReturn = toReturn.replace("à", "a'");
		toReturn = toReturn.replace("è", "e'");
		toReturn = toReturn.replace("ì", "i'");
		toReturn = toReturn.replace("ò", "o'");
		toReturn = toReturn.replace("ù", "u'");
